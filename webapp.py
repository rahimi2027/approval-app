...
# ============================================================
# ✅ v4.19 (WORK ORDER MANAGER DUPLICATE KEY FIX):
#    • Fixed: StreamlitDuplicateElementKey error caused by reusing
#      widget keys between the Work Order form and the Addition &
#      Deduction request form in the Work Order Manager portal.
#    • Renamed keys in the Addition/Deduction form to use the
#      "wo_mgr_req_" prefix to ensure they are unique.
...
# ============================================================
# GOOGLE DRIVE CONNECTION — SERVICE ACCOUNT (BASE64 METHOD v4.19)
# ============================================================
try:
